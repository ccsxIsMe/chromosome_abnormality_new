...
from src.models.correspondence_interval_profile_pair_model import CorrespondenceIntervalProfilePairClassifier
...
def build_model(
    ...
    if use_pair_input:
        ...
        elif pair_model_type == "correspondence_interval_profile":
            base_model = CorrespondenceIntervalProfilePairClassifier(
                backbone_name=model_name,
                num_classes=num_classes,
                pretrained=pretrained,
                use_chromosome_id=use_chromosome_id,
